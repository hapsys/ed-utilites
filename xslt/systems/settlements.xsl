...
-->
	<xsl:template name="canvas">
		<p>
			For details see <a target="_blank" href="https://docs.google.com/spreadsheets/d/1Y6jupbLF5RSunI4MEZkRfGmZGDt742HjeGuIyvvlQzQ/edit#gid=726725669">settlements type table</a>
		</p>
				...
				<ul class="list-inline">
					<xsl:for-each select="itemlist">
						<li><ul class="list-unstyled">
							<xsl:for-each select="field/row">
								<li>
									<div class="checkbox">
										<label>
											<input type="checkbox" name="stype" value="{col[@name='Type']/@value}" id="{col[@name='Type']/@value}"/>&#160;<xsl:value-of select="col[@name='Title']/@value"/>
										</label>
									</div>							
								</li>
							</xsl:for-each>
		...
		<p class="text-right">
			Based on <a target="_blank" href="https://docs.google.com/spreadsheets/d/1UxvrHe8qy1Pzzyo11Grqw6AkE8Acmch60NOR5MDzs1U/edit#gid=0">table</a> by DJa
		</p>
		<!-- Modal -->
